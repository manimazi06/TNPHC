...
/**
 * ProjectwiseDevelopmentWorkDetail Entity
 *
 * @property int $id
 ...
 * @property \App\Model\Entity\ProjectwiseDevelopmentWorkSubdetail[] $projectwise_development_work_subdetails
 */
class ProjectwiseDevelopmentWorkDetail extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'projectwise_development_work_subdetails' => true,
    ];
}
