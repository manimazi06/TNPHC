...
/**
 * ProjectwiseQuartersDetail Entity
 *
 * @property int $id
 * @property int|null $project_work_id
 * @property int|null $project_work_subdetail_id
 * @property int|null $police_designation_id
 * @property int|null $no_of_quarters
 ...
 * @property \App\Model\Entity\PoliceDesignation $police_designation
 */
class ProjectwiseQuartersDetail extends Entity
{
    /**
