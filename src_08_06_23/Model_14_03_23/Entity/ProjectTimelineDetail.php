 ...
 */
class ProjectTimelineDetail extends Entity
{
    /**
    ...
    protected $_accessible = [
        ...
        'work_stage_id' => true,
        'tentative_completion_date' => true,
        'is_active' => true,
        'created_by' => true,
        'created_date' => true,
        'modified_by' => true,
