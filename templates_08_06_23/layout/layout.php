					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">					     
						 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
						    <li <?php if($this->request->getParam('action') == 'dashboard'){?>class="nav-item active"<?php }?>>
							  ...
							  <li
                                <?php $masters = array('OldProjectWorkDetails','FinancialYears','Divisions');
                                echo (in_array($this->request->getParam('controller'),$masters)) ? 'class="nav-item active"': ' ';?>>
                                <a href="#" class="nav-link nav-toggle">
                                    <ion-icon name="apps-outline"></ion-icon>
                                    <span class="title">&nbsp;Completed Projects</span> <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">						   
									<!--li <?php if($this->request->getParam('controller') == 'OldProjectWorkDetails'){?>class="nav-item active"
                                        <?php }?>>
                                        <?php echo $this->Html->link('<ion-icon name="business-outline"></ion-icon><span class="title">&nbsp;Construction Work</span>', array('controller' => 'OldProjectWorkDetails', 'action' => 'complitedlist'), array('escape' => false, 'class' => 'nav-link')); ?>
                                    </li-->
									<li <?php if($this->request->getParam('controller') == 'OldProjectWorkDetails'){?>class="nav-item active"
                                        <?php }?>>
                                        <?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Repair Work</span>', array('controller' => 'OldProjectWorkDetails', 'action' => 'repairworklist'), array('escape' => false, 'class' => 'nav-link')); ?>
                                    </li>									
                                </ul>
                            </li>
							 <li
                            ...
                            <?php  }   ?>										
							 <?php if($LOGGED_ROLE == 1){   ?>	 							
								<li>
									<?php echo $this->Html->link('<ion-icon name="home-outline"></ion-icon><span class="title">&nbsp;Items Codes / Description</span>', array('controller' => 'BuildingItems', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
                               </li>
							  <?php  } ?>
							  <?php if($LOGGED_ROLE == 9 || $LOGGED_ROLE == 14 || $LOGGED_ROLE == 1){   ?>
							   <li
                                <?php $masters = array('OldProjectWorkDetails','FinancialYears','Divisions');
                                echo (in_array($this->request->getParam('controller'),$masters)) ? 'class="nav-item active"': ' ';?>>
                                <a href="#" class="nav-link nav-toggle">
                                    <ion-icon name="apps-outline"></ion-icon>
                                    <span class="title">&nbsp;Work In Progress</span> <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">						   
									<li <?php if($this->request->getParam('controller') == 'OldProjectWorkDetails'){?>class="nav-item active"
                                        <?php }?>>
                                        <?php echo $this->Html->link('<ion-icon name="business-outline"></ion-icon><span class="title">&nbsp;Construction Work</span>', array('controller' => 'OldProjectWorkDetails', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
                                    </li>
									<li <?php if($this->request->getParam('controller') == 'OldProjectWorkDetails'){?>class="nav-item active"
                                        <?php }?>>
                                        <?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Special Repair Work</span>', array('controller' => 'OldProjectWorkDetails', 'action' => 'specialrepairlist'), array('escape' => false, 'class' => 'nav-link')); ?>
                                    </li>									
                                </ul>
                              </li>
							...
							<?php  } ?>  
							 ...
							 <?php if($LOGGED_ROLE == 18){   ?>
							  ...
							  <?php } ?>
							  <?php if($LOGGED_ROLE == 6 || $LOGGED_ROLE == 8 || $LOGGED_ROLE == 1 || $LOGGED_ROLE == 17){    ?>
							 <li
