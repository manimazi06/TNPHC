                                                ...
                                                <?php $sno = 1;
													...
													<tr class="odd gradeX">
														...
														<td class="text-center">
															<?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Edit'), ['action' => 'projectabstractedit',$id,$work_id,$abstract_subdetail['id']], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm','target'=>'_blank']); ?><br><br>
															<?php echo $this->Html->link(__('<i class="fa fa-trash"></i> Delete'), ['action' => 'projectabstractdelete',$id,$work_id,$abstract_subdetail['id']], ['confirm' => __('Are you sure you want to delete item code - {0}?',  $abstract_subdetail['item_code']), 'class' => 'btn btn-outline-danger btn-sm', 'escape' => false]); ?>
														</td>
													</tr>
                                                <?php $sno++;
                                                    endforeach; ?>
