								...
								foreach ($notification_list as $notification) : ?>
									<tr>
										...
										<td align="left"><?php echo date('d-m-Y',strtotime($notification['forwarded_date'])); ?></td>
										    <?php  if($notification['work_type'] == 2 && $notification['notification_type_id'] == 2){ ?>
											
											<td align="left"><?php echo 'Repair Work approval'; ?></td>
										...
										<td class="text-center">
											<span style="margin-top:15px;">				   
												...
												<?php }else if($notification['notification_type_id'] == 13){  ?>
												<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'ProjectHandoverDetails','action' => 'projecthandoverdetails',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												<?php }else if($notification['notification_type_id'] == 14){  ?>
												<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'ProjectwiseCompletionReports','action' => 'projectwisecompletiondetails',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												<?php }else if($notification['notification_type_id'] == 15){  ?>
												<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'ProjectwiseCompletionReports','action' => 'projectcompletionapproval',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												<?php }else if($notification['notification_type_id'] == 16){  ?>
												<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'ProjectPlacedToBoardDetails','action' => 'projectplacedtoboard',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												<?php } ?>
											</span>
										</td>                                               
									</tr>
