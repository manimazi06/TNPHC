...
<div class="row">
   ...
   <div class="col">
      <div class="card crm-widget to-orange-600 rounded-lg">
         <div class="card-body">
            <h5 class="text-uppercase fs-13 text-amber-50">Forward to User Dept (CE Approved)</h5>
                  ...
                  <table class="table  table-bordered table-checkable order-column mobile-table">
                           ...
                           <tr class="odd gradeX">
                              ...
                              <td class="bol">
                                 ...
                                 <?php if ($totalproposed > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdivision(<?php echo  $key; ?>,2)"><?php echo $totalproposed; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalapproved > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdivision(<?php echo  $key; ?>,3)"><?php echo $totalapproved; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalsanctioned > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdivision(<?php echo  $key; ?>,4)"><?php echo $totalsanctioned; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalprogress > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdivision(<?php echo  $key; ?>,5)"><?php echo $totalprogress; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalcompleted > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdivision(<?php echo  $key; ?>,6)"><?php echo $totalcompleted; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                     ...
                     <tfoot>
                        <tr class="odd gradeX">
                           ...
                           <td class="bol"><?php echo $proposed; ?></td>
                           <td class="bol"><?php echo $approved; ?></td>
                           <td class="bol"><?php echo $sanctioned; ?></td>
                           <td class="bol"><?php echo $progress; ?></td>
                  ...
                  <table class="table  table-bordered table-checkable order-column mobile-table">
                        ...
                        foreach ($department_details as $key => $department) : ?>
                           <tr class="odd gradeX">
                              ...
                              <td class="bol">
                                 ...
                                 <?php if ($totalproposed > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdepart(<?php echo  $key; ?>,2)"><?php echo $totalproposed; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalapproved > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdepart(<?php echo  $key; ?>,3)"><?php echo $totalapproved; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalsanctioned > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdepart(<?php echo  $key; ?>,4)"><?php echo $totalsanctioned; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalprogress > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdepart(<?php echo  $key; ?>,5)"><?php echo $totalprogress; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                              <td class="bol">
                                 ...
                                 <?php if ($totalcompleted > 0) { ?>
                                    <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdepart(<?php echo  $key; ?>,6)"><?php echo $totalcompleted; ?></a>
                                 <?php } else {
                                    echo "0";
                                 } ?>
                              </td>
                     ...
                     <tfoot>
                        <tr class="odd gradeX">
                           ...
                           <td class="bol"><?php echo $proposed_dept; ?></td>
                           <td class="bol"><?php echo $approved_dept; ?></td>
                           <td class="bol"><?php echo $sanctioned_dept; ?></td>
                           <td class="bol"><?php echo $progress_dept; ?></td>
                           <td class="bol"><?php echo $completed_dept; ?></td>
                        </tr>
                     </tfoot>
                  </table>
               </div>
...
<script type="text/javascript">
   ...
   function getdepart(key, type) {
      ...
      $.ajax({
         ...
         dataType: "html",
         type: "post",
         url: '<?php echo $this->Url->webroot ?>/Reports/ajaxdepartment/' + key + "/" + type,
         success: function(data, textStatus) {
            // alert(data);
            $(".add-unsent-form").html(data);
         }
   ...
   function getdivision(id, type) {
      ...
      $.ajax({
         ...
         dataType: "html",
         type: "post",
         url: '<?php echo $this->Url->webroot ?>/Reports/ajaxdivisiontwisereport/' + id +
            "/" + type,
         success: function(data, textStatus) {
            // alert(data);
            $(".add-unsent-form").html(data);
