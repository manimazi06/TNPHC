				...
				<table  style="max-width:98%;margin-left:1%;">						  
					   ...
					   <tr>
						  ...
						  <td style="padding:13px;width:30%;border:1px solid black;"> <?php if ($contractor_details['agreement_copy'] != '') {  ?>
								 ...
								 <?php   }  ?></td>
						  <td style="padding:13px;width:20%;background-color: #244f96;color: #fff;border: 1px solid #fff;font-weight:600;">Agreement Amount</td>
						  <td style="padding:13px;width:30%;border:1px solid black;"><?php  echo ($projectWork['coastal_area'] == 1)?'Yes':'No'; ?>     </td>
					   </tr>
						<tr>
						...
						<table style="width:100%;">
							<thead>  
								<tr align="center">
									...
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Work Code</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Work Name</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Place / Area Name</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">District</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Division</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Circle</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Rough Cost <br>(in Rs.)</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">AS Sanctioned Amount <br>(in Rs.)</th>
									<th style="width:10%;padding:13px;border:1px solid black;font-weight:600;">Work Status</th>
								</tr>
							</thead>
							<tbody>
							   <?php
			 ...
			 <table style="width:100%;">
			   <tr>
			     <td>
			       ...
			       <!--iframe src="http://localhost/uploads/AdministrativeSanctions/<?php //echo $administrativesanction[0]['go_file_upload']; ?>#toolbar=0" height="1350" width="1100"  style="overflow: hidden;"></iframe--> 
		         </td>
		       </tr>
			</table>
		<?php  } */ ?>			
