                                                ...
                                                <?php $sno = 1;
													...
													<tr class="odd gradeX">
														...
														<td class="text-center">
															...
															<?php echo $this->Html->link(__('<i class="fa fa-trash"></i> Delete'), ['action' => 'projectabstractdelete',$id,$pid,$work_id,$abstract_subdetail['id']], ['confirm' => __('Are you sure you want to delete item code - {0}?',  $abstract_subdetail['item_code']), 'class' => 'btn btn-outline-danger btn-sm', 'escape' => false]); ?>
														</td>
													</tr>
                                                <?php $sno++;
                                                    endforeach; ?>
                 ...
                 <fieldset  style="border:1px solid #00355F;border-radius:10px; margin-top:0%;padding:10px;margin-left:5px;margin-bottom:0%">
				   <div class="col-md-12">
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-md-4">
								 <?php echo $this->Form->control('amount', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Amount','required','value'=>($tot_amount)?$tot_amount:$technical['amount'],'readonly']) ?>
                                     </div>
