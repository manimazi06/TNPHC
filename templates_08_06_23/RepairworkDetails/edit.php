...
<div class="col-md-12">
    ...
    <div class="card card-topline-aqua">
        <div class="card-head">
            <header>Edit Repair work Detail</header>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                <div class="form-body row">
                    <div class="col-md-12">
					     <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('ref_no', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'placeholder' => 'Enter Ref No',  'required','type'=>'textarea','rows'=>3]); ?>
                            </div>                          
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('division_id', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $divisions, 'label' => false, 'error' => false, 'id' => 'project-division-id', 'empty' => 'Select Division', 'required', 'disabled']); ?>
                                <?php echo $this->Form->control('project_division_id1', ['type' => 'hidden', 'label' => false, 'error' => true, 'value' => $repairworkDetail['division_id']]) ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php echo $this->Form->control('project_circle_id1', ['type' => 'hidden', 'label' => false, 'error' => true, 'value' => $repairworkDetail['circle_id']]) ?>

                            </div>
                            <label class="control-label col-md-2 ">Estimated Cost (in Rs.)<span class="required"> *
                                </span></label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('work_file_upload', ['class' => 'form-control ', 'label' => false, 'error' => true, 'type' => 'file', 'accept' => '.pdf,.jpg,.png,.jpeg', 'onchange' => 'validdocs(this)']); ?>
                                <?php if ($repairworkDetail['work_file_upload'] != '') {  ?>
                                <?php echo $this->Form->control('work_file_upload1', ['type' => 'hidden', 'value' => $repairworkDetail['work_file_upload']]); ?>
                                <a style="color:blue;"
...
function loadcircle(id) {
    ...
    if (id) {
        ...
        $('#project-division-id').html('<option value="">Select Circle</option>');
...
// <?php if ($repairworkDetail['work_file_upload'] > 0) {  ?>
// required: false
// <?php } else { ?>
// required: true
// <?php  } ?>
