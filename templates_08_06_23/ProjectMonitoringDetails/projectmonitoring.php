                    ...
                    <div class="form-body row">
                        <div class="form-group">
                            <div class="col-md-12" style="margin-top:">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-2 bol">Photo upload type:<span class="required">* </span></label>
                                    <div class="col-md-4">
                                        <?php echo $this->Form->control('file_type_id', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'options' => $file_type, 'empty' => 'Select Percentage', 'required', 'onchange' => 'fileupload(this.value)']) ?>

                                    </div>
                                </div>
                                <div class="form-group row fileopen" style="display:none;">
                            ...
                            <center>
                                <table id="answerTable" class="table  table-bordered  order-column fileopen1" style="max-width: 40%;margin-left: 5%;margin-top:1%; display:none;">
                                    <thead>
                                        <tr align="center">
            ...
            function getaddempdoc() {
                ...
                if (j != '') {
                    $.ajax({
                        async: true,
                        dataType: "html",
                        url: '<?php echo $this->Url->webroot ?>/ProjectMonitoringDetails/ajaxmonitor/' + j,
