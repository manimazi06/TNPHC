...
<div class="row">
 <div class="col-md-12">
	...
	<table class="ajaxclass" style="width:97%">   
	  <tr>
	    <th colspan="2" style="border: 1px solid; padding:6px;width:50%;">Monitoring Date: &nbsp;<?php echo date('d-m-Y', strtotime($monitoringDetails[1]['monitoring_date'])) ?></th>
	    <th colspan="2" style="border: 1px solid; padding:6px;width:50%;">Monitoring Date: &nbsp;<?php echo date('d-m-Y', strtotime($monitoringDetails[0]['monitoring_date'])) ?></th>
	  </tr>
	  <tr>
	    <td colspan="2" style="border: 1px solid; padding:6px;width:50%;"><img src="<?php echo $this->Url->build('/uploads/Projectmonitoring/'.$photo[1]) ?>" height="100%" width="100%"></td>
	    <td colspan="2" style="border: 1px solid; padding:6px;width:50%;"><img src="<?php echo $this->Url->build('/uploads/Projectmonitoring/'.$photo[0]) ?>" height="100%" width="100%"></td>
	  </tr>
	   <tr>
