										...
										<tbody>
											...
											foreach ($projects as $project) : ?>
												<tr class="odd gradeX">
													...
													<td class="text-center"><?php echo $project['amount']; ?></td>
												</tr>
											<?php $sno++;
												$total_sanction  += $project['amount'];
											endforeach; ?>
...
<script>
    ...
    // function getempdesgn(val, divid) {
        ...
        // $.ajax({
            ...
            // dataType: "html",
            // type: "post",
            // url: '<?php echo $this->Url->webroot ?>/OpeningBalanceLogs/ajaxdivisionwise/' + val + '/' + month_date + '/' + divid + '/' + office_wise,
