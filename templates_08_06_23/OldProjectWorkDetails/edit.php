...
<div class="col-md-12">
    ...
    <div class="card card-topline-aqua">
        <div class="card-head">
            <header>Edit WIP Project Details</header>
        </div>
        <div class="card-body">
            <div class="col-md-12">
                <div class="form-body row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('go_no', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'placeholder' => 'Enter GO Details',  'required','type'=>'textarea','rows'=>3]); ?>
                            </div>
