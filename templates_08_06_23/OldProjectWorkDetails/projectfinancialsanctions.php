<div class="row">
                                 ...
                                 <table id="answerTable" class="table  table-bordered  order-column" style="max-width: 99%;margin-left: 1%;">
                                     ...
                                     <tbody class="add_doc">
                                         <tr class="present_row">
                                             ...
                                             <td><?php echo $this->Form->control('sanctioned_amount', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Sanction Amount', 'required','min'=>1,'maxlength'=>15, 'value' => ($projectFinancialSanction['sanctioned_amount'])?$projectFinancialSanction['sanctioned_amount']:$oldProjectWorkDetail['fs_value']]) ?>
                                             </td>
 ...
 <script>
 <?php if($role_id != 1){ ?>
 $('#sanctioned-amount').prop('readonly', true);
 <?php } ?>
     $("#FormID").validate({
        rules: {
            'go_no': {
