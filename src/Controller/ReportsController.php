  ...
  {  
   ...
   $user = $this->request->getAttribute('identity');
	...
	foreach($prjectdetails as $project){
	 ...
	 $monitoring[$project['sub_detail_id']]    = $this->ProjectMonitoringDetails->find('all')->contain(['ProjectWorks', 'WorkStages', 'WorkPercentages', 'FinancialPercentages'])->where(['ProjectMonitoringDetails.project_work_subdetail_id' =>$project['sub_detail_id']])->last();
