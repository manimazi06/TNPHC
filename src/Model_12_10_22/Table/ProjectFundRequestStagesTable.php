 ...
 *
 * @property \App\Model\Table\ProjectFundRequestDetailsTable&\Cake\ORM\Association\BelongsTo $ProjectFundRequestDetails
...
class ProjectFundRequestStagesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('ProjectFundRequestDetails', [
    ...
    {
        $validator
            ->integer('project_fund_request_detail_id')
            ->allowEmptyString('project_fund_request_detail_id');
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn('project_fund_request_detail_id', 'ProjectFundRequestDetails'), ['errorField' => 'project_fund_request_detail_id']);
